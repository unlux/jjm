...
export async function generateMetadata(props: {
  ...
  const canonicalPath = `/${countryCode}/privacy-policy`
  const languages = buildHreflangMap(countryCodes, (cc) => `/${cc}/privacy-policy`)

  return {
    title: "Privacy Policy",
    description: "Privacy policy for The Joy Junction.",
    alternates: {
